# -*- coding: utf-8 -*-
from LineAlpha import LineAlpha
from LineAlpha.LineApi import Line Tracer
from LineAlpha.LineThrift.ttypes import Massage
from LineAlpha.LineThrift.Talkservice import Client
from time, datetime, random, sys, re, string, os, json
...
profile, settings, tracer = client.getProfile(), client.getEttings(), LineTracer(client)
offbot, messangeReq, wordsArray, waitingAnsware = [], {}, {}, {}
...
admin=["u205e00175e0be96d571a70021cb0492a"]
wait = {
    'contact':False,
    'autoJoin':True,
...
#-----------------------------------------------
                ...
                ki.sendText(msg.to,"Luciffer")
                kk.sendText(msg.to,"Hayato")
